...
* [🪿 LLM应用](llm-application/README.md)
  * [信息检索](llm-application/info-retrieval/README.md)
    ...
    * [语言学资源驱动的相似度计算](llm-application/info-retrieval/resource-based-similarity.md)
...
* [🎄 LLM训练](train/README.md)
  ...
  * [强化学习](train/reinforce-learning/README.md)
    * [RLHF基础](train/reinforce-learning/rlhf-basics.md)
    * [Reward Model](train/reinforce-learning/reward-model.md)
    * [PPO](train/reinforce-learning/ppo.md)
