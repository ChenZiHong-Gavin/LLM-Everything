...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p><strong>🪿 深度学习基础</strong></p><ul><li>🚧 持续更新中...</li></ul>                                                                                                                                                                                                 | <p><strong>🐬 LLM 基础</strong></p><ul><li><a href="basics/llm-basics/switch-thinking.md">思考模式切换</a></li></ul>                                                                                                                                                                                                                                                                                                                                                                                |
...
| **训练流程**  | <ul><li><a href="train/pre-train.md">预训练</a></li><li><a href="train/sft.md">监督微调</a></li><li>强化学习 🚧</li></ul>                                                                                                                                                                                                                                                                               |
